...
<!-- Mirrored from 7oroof.com/demos/medcity/home-modern.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jul 2021 23:23:26 GMT -->
<head>
  <meta charset="UTF-8" />
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav__item has-dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav__item">
                    <a href="home-modern.php" class="nav__item-link"> Modern</a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
                    <a href="home-classic.php" class="nav__item-link"> Classic</a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
                    <a href="home-dentist.php" class="nav__item-link"> Dentist</a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
                    <a href="home-pharmacy.php" class="nav__item-link"> Pharmacy</a>
                  </li><!-- /.nav-item -->
                </ul><!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              <li class="nav__item has-dropdown">
...
<!-- Mirrored from 7oroof.com/demos/medcity/home-modern.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jul 2021 23:23:27 GMT -->
</html>